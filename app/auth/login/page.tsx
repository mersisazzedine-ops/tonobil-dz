    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 sm:p-10 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" onClick={() => handleOAuthLogin('google')} disabled={isSubmitting} className="flex items-center justify-center gap-2 border-2 border-gray-100 rounded-xl py-3.5 text-sm font-bold text-gray-700 hover:border-gray-200 hover:bg-gray-50 transition-all disabled:opacity-60">
            ...
            <button type="button" onClick={() => handleOAuthLogin('facebook')} disabled={isSubmitting} className="flex items-center justify-center gap-2 border-2 border-gray-100 rounded-xl py-3.5 text-sm font-bold text-gray-700 hover:border-gray-200 hover:bg-gray-50 transition-all disabled:opacity-60">
